...
test('creates value', async t => {
  ...
  const value = createValue(source, defaultValues.healthy)
...
test('creates attempts observable', async t => {
  ...
  const value = createValue(source, defaultValues.attempts)
...
test('creates successes observable', async t => {
  ...
  const value = createValue(source, defaultValues.successes)
  t.is(value(), 0, 'for initial value')
  await t.context.emit(true)
...
test('creates failures observable', async t => {
  ...
  const value = createValue(source, defaultValues.failures)
  t.is(value(), 0, 'for initial value')
  await t.context.emit(true)
